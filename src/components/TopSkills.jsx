          ...
          .map((course) => (
            ...
            >
              ...
              <div className="relative w-full h-[250px] overflow-hidden rounded-t-lg">
                ...
                <p className="absolute top-5 left-5 bg-white text-black text-xs px-2 py-1 rounded">
                  {course.category}
                </p>
              </div>
              ...
              <div className="p-6 pb-6">
                ...
                <button
                  onClick={() => handleViewDetails(course.id)}
                  className="w-full h-10 rounded-md bg-gradient-to-r from-[#4e2ecf] to-[#a57aeb] text-white font-medium mt-2 flex items-center justify-center"
                >
